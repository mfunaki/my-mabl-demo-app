...
- ワークフロー `.github/workflows/deploy-api.yml` はデプロイ成功後に mabl CLI（`npm install -g @mablhq/mabl-cli`）をインストールし、`mabl tests run --id ykrgAm2iDrn2sTYoH3Xm3Q-j` を実行してAPIを検証します。
